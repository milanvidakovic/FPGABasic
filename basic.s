...
exec_exec:
	...
	mov.w	r13, sp	#,
	sub.w	sp, 128 #111	#,
# basic.c:2156: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:2157: 	if (*txtpos < 'A' || *txtpos > 'Z')
...
# basic.c:2160: 		return;
	j	.L410		#
.L412:
# basic.c:2164: 	for (i = 0; txtpos[i] != NL && txtpos[i] != CR && i < 32; i++)
	xor.w	r0, r0	# tmp65
	st.w	[r13 + (-4)], r0	# i, tmp65
# basic.c:2164: 	for (i = 0; txtpos[i] != NL && txtpos[i] != CR && i < 32; i++)
	j	.L414		#
.L416:
# basic.c:2167: 		s[i] = txtpos[i];
...
# basic.c:2171: 	i = 0;
	xor.w	r0, r0	# tmp81
	st.w	[r13 + (-4)], r0	# i, tmp81
# basic.c:2172: 	printf("Loading program: %s\n", s);
	mov.w	r0, sp	# tmp82,
	mov.w	r1, r13	# tmp83,
...
# basic.c:2173: 	if (drive == 0)
	...
	cmp.w	r1, r0	# tmp85, tmp86
	jnz	.L417		#
# basic.c:2177: 		if(file_open(s, &fd, O_READ))
	mov.w	r0, sp	# tmp87,
	xor.w	r1, r1	# tmp88
	st.w	[r0 + (8)], r1	#, tmp88
	mov.w	r1, r13	# tmp89,
...
# basic.c:2177: 		if(file_open(s, &fd, O_READ))
	...
	cmp.w	r1, r0	# tmp91, tmp92
	jz	.L422		#
# basic.c:2179: 			int len = fd.dir_entry.filesize;
	ld.w	r0, [r13 + (-72)]	# _20, fd.dir_entry.filesize
# basic.c:2179: 			int len = fd.dir_entry.filesize;
	st.w	[r13 + (-12)], r0	# len, _20
# basic.c:2180: 			int total = 0;
	xor.w	r0, r0	# tmp93
	st.w	[r13 + (-8)], r0	# total, tmp93
# basic.c:2182: 			while(total < len)
	j	.L419		#
.L421:
# basic.c:2184: 				current = file_read(&fd, &buffer[total], 512);
...
# basic.c:2188: 						printf("#");
	...
	j	.L419		#
.L420:
# basic.c:2191: 					printf("Error reading file!\n");
	mov.w	r1, sp	# tmp108,
...
# basic.c:2200: 	else if (drive == 2)
	...
	jnz	.L423		#
# basic.c:2204: 		delay(100);
	mov.w	r1, sp	# tmp116,
	mov.w	r0, 100	# tmp117,
	st.w	[r1], r0	#, tmp117
	call	delay		#
# basic.c:2205: 		i = uart_read_file(buffer, s);
	...
	j	.L422		#
.L423:
# basic.c:2209: 		i = eth_read_file(buffer, s);
...
# basic.c:2215: 		video_mode(0);
	...
	st.w	[r1], r0	#, tmp125
	call	video_mode		#
# basic.c:2217: 		uart_init_files();
	call	uart_init_files		#
# basic.c:2218: 		init_spi();
	call	init_spi		#
# basic.c:2219: 		init_eth();
	call	init_eth		#
	j	.L410		#
.L424:
...
exec_drive:
	...
	mov.w	r13, sp	#,
	sub.w	sp, 24 #111	#,
# basic.c:2253: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:2254: 	if (*txtpos == NL)
...
# basic.c:2257: 		return;
	j	.L430		#
.L431:
# basic.c:2259: 	if (*txtpos < '0' || *txtpos > '9')
...
# basic.c:2265: 	if (drive >= 0 && drive <= 2)
...
# basic.c:2266: 		printf("DRIVE: %d\n", drive);
	...
	j	.L430		#
.L435:
# basic.c:2269: 		printf("Invalid drive number: %d. Can be from 0 to 2.\n", drive);
...
exec_eth:
	...
	mov.w	r13, sp	#,
	sub.w	sp, 24 #111	#,
# basic.c:2276: 	ignore_blanks();
	call	ignore_blanks		#
# basic.c:2277: 	if (*txtpos == NL)
...
# basic.c:2277: 	if (*txtpos == NL)
	...
	cmp.w	r1, r0	# tmp42, tmp43
	jnz	.L437		#
# basic.c:2279: 		printf("ETHERNET: %d\n", eth);
...
# basic.c:2280: 		return;
	j	.L436		#
.L437:
# basic.c:2282: 	if (*txtpos < '0' || *txtpos > '9')
...
# basic.c:2288: 	if (eth >= 0 && eth <= 1) 
	...
	jgs	.L441		#
# basic.c:2290: 		printf("ETHERNET: %d\n", eth);
...
# basic.c:2292: 		if (eth == 1)
	j	.L436		#
.L441:
# basic.c:2301: 		printf("Invalid ethernet value: %d. Can be 0 or 1.\n", eth);
...
# basic.c:2315: 	expression_error = 0;
	xor.w	r0, r0	# tmp36
	st.b	[expression_error], r0	# expression_error, tmp36
# basic.c:2316: 	if (expression_error)
...
# basic.c:2319: 		return;
	j	.L444		#
.L447:
# basic.c:2321: 	color = expression();	
	call	expression		#
# basic.c:2321: 	color = expression();	
	st.w	[color], r0	# color, _5
# basic.c:2322: 	printf("COLOR SET TO: %d\n", color);
...
# basic.c:2331: 	if (*txtpos == NL)
	...
	cmp.w	r1, r0	# tmp48, tmp49
	jnz	.L450		#
# basic.c:2332: 		return 0;
	xor.w	r0, r0	# _19
	j	.L451		#
.L450:
# basic.c:2334: 	scantable(keywords);
	mov.w	r1, sp	# tmp50,
	mov.w	r0, keywords	# tmp51,
	st.w	[r1], r0	#, tmp51
	call	scantable		#
# basic.c:2340: 	if (should_break())
	call	should_break		#
	mov.w	r1, r0	# _3,
# basic.c:2340: 	if (should_break())
	xor.w	r0, r0	# tmp52
	...
	jz	.L452		#
# basic.c:2342: 		return 0;
	xor.w	r0, r0	# _19
	j	.L451		#
.L452:
# basic.c:2345: 	switch (table_index)
	...
	j	.L497		#
.L489:
# basic.c:2349: 		exec_mem();
	call	exec_mem		#
# basic.c:2350: 		return 0;
	xor.w	r0, r0	# _19
	j	.L451		#
.L497:
# basic.c:2354: 		return 1;
	mov.w	r0, 1	# _19,
	j	.L451		#
.L488:
# basic.c:2357: 		exec_print();
	call	exec_print		#
# basic.c:2358: 		break;
	j	.L491		#
.L487:
# basic.c:2360: 		exec_list();
	call	exec_list		#
# basic.c:2361: 		break;
	j	.L491		#
.L486:
# basic.c:2363: 		current_line = program_start;
	ld.w	r0, [program_start]	# program_start.453_6, program_start
	st.w	[current_line], r0	# current_line, program_start.453_6
# basic.c:2364: 		exec_run();
	call	exec_run		#
# basic.c:2365: 		break;
	j	.L491		#
.L485:
# basic.c:2367: 		program_end = program_start;
	ld.w	r0, [program_start]	# program_start.454_7, program_start
	st.w	[program_end], r0	# program_end, program_start.454_7
# basic.c:2368: 		break;
	j	.L491		#
.L484:
# basic.c:2370: 		assignment();
	call	assignment		#
# basic.c:2371: 		break;
	j	.L491		#
.L483:
# basic.c:2373: 		exec_if();
	call	exec_if		#
# basic.c:2374: 		break;
	j	.L491		#
.L482:
# basic.c:2376: 		expression_error = 0;
	xor.w	r0, r0	# tmp126
	st.b	[expression_error], r0	# expression_error, tmp126
# basic.c:2377: 		linenum = expression();
	call	expression		#
# basic.c:2377: 		linenum = expression();
	st.w	[linenum], r0	# linenum, _8
# basic.c:2378: 		if (expression_error || *txtpos != NL)
...
# basic.c:2379: 			qhow();
	call	qhow		#
.L493:
# basic.c:2380: 		current_line = findline();
	call	findline		#
# basic.c:2380: 		current_line = findline();
	st.w	[current_line], r0	# current_line, _12
# basic.c:2381: 		return 2;
	mov.w	r0, 2	# _19,
	j	.L451		#
.L481:
# basic.c:2383: 		exec_for();
	call	exec_for		#
# basic.c:2384: 		break;
	j	.L491		#
.L480:
# basic.c:2386: 		exec_next();
	call	exec_next		#
# basic.c:2387: 		break;
	j	.L491		#
.L478:
# basic.c:2389: 		exec_gosub();
	call	exec_gosub		#
# basic.c:2390: 		break;
	j	.L491		#
.L479:
# basic.c:2392: 		if (!exec_return())
	call	exec_return		#
	mov.w	r1, r0	# _13,
# basic.c:2392: 		if (!exec_return())
	xor.w	r0, r0	# tmp131
	...
	jnz	.L499		#
# basic.c:2393: 			return 1;
	mov.w	r0, 1	# _19,
	j	.L451		#
.L477:
# basic.c:2398: 		if (txtpos[0] != NL)
...
# basic.c:2410: 		break;
	j	.L491		#
.L474:
# basic.c:2412: 		return exec_edit();
	call	exec_edit		#
	j	.L451		#
.L473:
# basic.c:2414: 		exec_load();
	call	exec_load		#
# basic.c:2415: 		break;
	j	.L491		#
.L472:
# basic.c:2417: 		exec_save();
	call	exec_save		#
# basic.c:2418: 		break;
	j	.L491		#
.L471:
# basic.c:2420: 		exec_dir();
	call	exec_dir		#
# basic.c:2421: 		break;
	j	.L491		#
.L470:
# basic.c:2423: 		exec_mode();
	call	exec_mode		#
# basic.c:2424: 		break;
	j	.L491		#
.L469:
# basic.c:2426: 		exec_plot();
	call	exec_plot		#
# basic.c:2427: 		break;
	j	.L491		#
.L468:
# basic.c:2429: 		exec_line();
	call	exec_line		#
# basic.c:2430: 		break;
	j	.L491		#
.L467:
# basic.c:2432: 		exec_circle();
	call	exec_circle		#
# basic.c:2433: 		break;
	j	.L491		#
.L466:
# basic.c:2435: 		exec_draw();
	call	exec_draw		#
# basic.c:2436: 		break;
	j	.L491		#
.L465:
# basic.c:2438: 		exec_help();
	call	exec_help		#
# basic.c:2439: 		break;
	j	.L491		#
.L464:
# basic.c:2441: 		exec_delay();
	call	exec_delay		#
# basic.c:2442: 		break;
	j	.L491		#
.L463:
# basic.c:2444: 		exec_cursor();
	call	exec_cursor		#
# basic.c:2445: 		break;
	j	.L491		#
.L462:
# basic.c:2447: 		exec_poke();
	call	exec_poke		#
# basic.c:2448: 		break;
	j	.L491		#
.L461:
# basic.c:2450: 		exec_exec();
	call	exec_exec		#
# basic.c:2451: 		break;
	j	.L491		#
.L460:
# basic.c:2453: 		exec_sys();
	call	exec_sys		#
# basic.c:2454: 		break;
	j	.L491		#
.L459:
# basic.c:2456: 		exec_drive();
	call	exec_drive		#
# basic.c:2457: 		break;
	j	.L491		#
.L458:
# basic.c:2459: 		printf("Current millis: %d\n", get_millis());
	call	get_millis		#
	mov.w	r1, r0	# _18,
	mov.w	r0, sp	# tmp135,
	st.w	[r0 + (4)], r1	#, _18
...
# basic.c:2460: 	break;
	j	.L491		#
.L456:
# basic.c:2465: 		exec_eth();
	call	exec_eth		#
# basic.c:2466: 		break;
	j	.L491		#
.L455:
# basic.c:2468: 		exec_color();
	call	exec_color		#
# basic.c:2469: 		break;
	j	.L491		#
.L453:
...
init_K_API:
	push	r13		#
	mov.w	r13, sp	#,
# basic.c:2480: 	K_API_STDIO[K_CLS] 				= ((int)cls) + 4;               // 190000 
...
# basic.c:2481: 	K_API_STDIO[K_PUT_CHAR] 		= ((int)put_char) + 4;          // 190004 
...
# basic.c:2481: 	K_API_STDIO[K_PUT_CHAR] 		= ((int)put_char) + 4;          // 190004 
	st.w	[r0], r1	# *_6, _7
# basic.c:2482: 	K_API_STDIO[K_PRINTF] 			= ((int)printf) + 4;            // 190008 
...
# basic.c:2482: 	K_API_STDIO[K_PRINTF] 			= ((int)printf) + 4;            // 190008 
	st.w	[r0], r1	# *_10, _11
# basic.c:2483: 	K_API_STDIO[K_PUTS] 			= ((int)puts) + 4;              // 190012 
...
# basic.c:2483: 	K_API_STDIO[K_PUTS] 			= ((int)puts) + 4;              // 190012 
	st.w	[r0], r1	# *_14, _15
# basic.c:2484: 	K_API_STDIO[K_RAND] 			= ((int)rand) + 4;              // 190016 
...
# basic.c:2484: 	K_API_STDIO[K_RAND] 			= ((int)rand) + 4;              // 190016 
	st.w	[r0], r1	# *_18, _19
# basic.c:2485: 	K_API_STDIO[K_SHOULD_BREAK] 	= ((int)should_break) + 4;      // 190020 
...
# basic.c:2485: 	K_API_STDIO[K_SHOULD_BREAK] 	= ((int)should_break) + 4;      // 190020 
	st.w	[r0], r1	# *_22, _23
# basic.c:2486: 	K_API_STDIO[K_GETC] 			= ((int)getc) + 4;              // 190024 
...
# basic.c:2486: 	K_API_STDIO[K_GETC] 			= ((int)getc) + 4;              // 190024 
	st.w	[r0], r1	# *_26, _27
# basic.c:2487: 	K_API_STDIO[K_GETS] 			= ((int)gets) + 4;              // 190028 
...
# basic.c:2487: 	K_API_STDIO[K_GETS] 			= ((int)gets) + 4;              // 190028 
	st.w	[r0], r1	# *_30, _31
# basic.c:2488: 	K_API_STDIO[K_INIT_STDIO] 		= ((int)init_stdio) + 4;        // 190032 
...
# basic.c:2488: 	K_API_STDIO[K_INIT_STDIO] 		= ((int)init_stdio) + 4;        // 190032 
	st.w	[r0], r1	# *_34, _35
# basic.c:2489: 	K_API_STDIO[K_DELAY] 			= ((int)delay) + 4;             // 190036 
...
# basic.c:2489: 	K_API_STDIO[K_DELAY] 			= ((int)delay) + 4;             // 190036 
	st.w	[r0], r1	# *_38, _39
# basic.c:2490: 	K_API_STDIO[K_XY] 				= ((int)xy) + 4;                // 190040 
...
# basic.c:2490: 	K_API_STDIO[K_XY] 				= ((int)xy) + 4;                // 190040 
	st.w	[r0], r1	# *_42, _43
# basic.c:2491: 	K_API_STDIO[K_GET_MILLIS]		= ((int)get_millis) + 4;        // 190044 
...
# basic.c:2491: 	K_API_STDIO[K_GET_MILLIS]		= ((int)get_millis) + 4;        // 190044 
	st.w	[r0], r1	# *_46, _47
# basic.c:2492: 	K_API_STDIO[K_IS_KEY_PRESSED]	= ((int)is_key_pressed) + 4;    // 190048 
...
# basic.c:2492: 	K_API_STDIO[K_IS_KEY_PRESSED]	= ((int)is_key_pressed) + 4;    // 190048 
	st.w	[r0], r1	# *_50, _51
# basic.c:2493: 	K_API_STDIO[K_IS_KEY_RELEASED]	= ((int)is_key_released) + 4;   // 190052 
...
# basic.c:2493: 	K_API_STDIO[K_IS_KEY_RELEASED]	= ((int)is_key_released) + 4;   // 190052 
	st.w	[r0], r1	# *_54, _55
# basic.c:2494: 	K_API_STDIO[K_TOGGLE_CURSOR] 	= ((int)toggle_cursor) + 4;     // 190056 
...
# basic.c:2494: 	K_API_STDIO[K_TOGGLE_CURSOR] 	= ((int)toggle_cursor) + 4;     // 190056 
	st.w	[r0], r1	# *_58, _59
# basic.c:2495: 	K_API_STDIO[K_PUTCHAR]			= ((int)putchar) + 4;           // 190060 
...
# basic.c:2495: 	K_API_STDIO[K_PUTCHAR]			= ((int)putchar) + 4;           // 190060 
	st.w	[r0], r1	# *_62, _63
# basic.c:2496: 	K_API_STDIO[K_VIDEO_MODE]		= ((int)video_mode) + 4;        // 190064 
...
# basic.c:2496: 	K_API_STDIO[K_VIDEO_MODE]		= ((int)video_mode) + 4;        // 190064 
	st.w	[r0], r1	# *_66, _67
# basic.c:2497: 	K_API_GRAPHICS[K_SCROLL_UP]	    = ((int)scroll_up) + 4;			// 190068
...
# basic.c:2497: 	K_API_GRAPHICS[K_SCROLL_UP]	    = ((int)scroll_up) + 4;			// 190068
	st.w	[r0], r1	# *_70, _71
# basic.c:2499: 	K_API_STRING[K_STRLEN] =        ((int)strlen) + 4;				// 190100 
...
# basic.c:2500: 	K_API_STRING[K_STRCMP] =        ((int)strcmp) + 4;				// 190104 
...
# basic.c:2500: 	K_API_STRING[K_STRCMP] =        ((int)strcmp) + 4;				// 190104 
	st.w	[r0], r1	# *_77, _78
# basic.c:2501: 	K_API_STRING[K_STRNCMP] =       ((int)strncmp) + 4;				// 190108 
...
# basic.c:2501: 	K_API_STRING[K_STRNCMP] =       ((int)strncmp) + 4;				// 190108 
	st.w	[r0], r1	# *_81, _82
# basic.c:2502: 	K_API_STRING[K_MEMCPY] =        ((int)memcpy) + 4; 				// 190112 
...
# basic.c:2502: 	K_API_STRING[K_MEMCPY] =        ((int)memcpy) + 4; 				// 190112 
	st.w	[r0], r1	# *_85, _86
# basic.c:2503: 	K_API_STRING[K_MEMSET] =        ((int)memset) + 4; 				// 190116 
...
# basic.c:2503: 	K_API_STRING[K_MEMSET] =        ((int)memset) + 4; 				// 190116 
	st.w	[r0], r1	# *_89, _90
# basic.c:2504: 	K_API_STRING[K_MEMMOVE] =       ((int)memmove) + 4; 			// 190120 
...
# basic.c:2504: 	K_API_STRING[K_MEMMOVE] =       ((int)memmove) + 4; 			// 190120 
	st.w	[r0], r1	# *_93, _94
# basic.c:2505: 	K_API_STRING[K_STRCPY] =        ((int)strcpy) + 4; 				// 190124 
...
# basic.c:2505: 	K_API_STRING[K_STRCPY] =        ((int)strcpy) + 4; 				// 190124 
	st.w	[r0], r1	# *_97, _98
# basic.c:2506: 	K_API_STRING[K_STRNCPY] =       ((int)strncpy) + 4; 			// 190128 
...
# basic.c:2507: 	K_API_STRING[K_STRCAT] =        ((int)strcat) + 4;				// 190132 
...
# basic.c:2508: 	K_API_STRING[K_STRSTR] =        ((int)strstr) + 4;				// 190136 
...
# basic.c:2509: 	K_API_STRING[K_TOLOWER] =       ((int)tolower) + 4;				// 190140 
...
# basic.c:2510: 	K_API_STRING[K_TOUPPER] =       ((int)toupper) + 4;				// 190144 
...
# basic.c:2511: 	K_API_STRING[K_STR_TOUPPER] =   ((int)str_toupper) + 4;			// 190148 
...
# basic.c:2512: 	K_API_STRING[K_STR_N_TOUPPER] = ((int)str_n_toupper) + 4;		// 190152 
...
# basic.c:2513: 	K_API_STRING[K_ISDIGIT] =       ((int)isdigit) + 4;				// 190156 
...
# basic.c:2514: 	K_API_STRING[K_ISLOWER] =       ((int)islower) + 4;				// 190160 
...
# basic.c:2515: 	K_API_STRING[K_ISUPPER] =       ((int)isupper) + 4;				// 190164 
...
# basic.c:2516: 	K_API_STRING[K_ISALPHA] =       ((int)isalpha) + 4;				// 190168 
...
# basic.c:2517: 	K_API_STRING[K_ISALNUM] =       ((int)isalnum) + 4;				// 190172 
...
# basic.c:2518: 	K_API_STRING[K_ATOI] =          ((int)atoi) + 4;				// 190176 
...
# basic.c:2519: 	K_API_STRING[K_ISSPACE] =       ((int)isspace) + 4;				// 190180 
...
# basic.c:2520: 	K_API_STRING[K_MEMCMP] =        ((int)memcmp) + 4;		 	 	// 190184 
...
# basic.c:2521: 	K_API_STRING[K_STRTOK] =        ((int)strtok) + 4;				// 190188 
...
# basic.c:2522: 	K_API_STRING[K_STRCHR] =        ((int)strchr) + 4; 				// 190192 
...
# basic.c:2523: 	K_API_STRING[K_STRRRCHR] =      ((int)strrchr) + 4; 			// 190196 
...
# basic.c:2524: 	K_API_STRING[K_STRNCASECMP] =   ((int)strncasecmp) + 4; 		// 190200 
...
# basic.c:2526: 	K_API_SPRINTF[K_SPRINTF]	= 	((int)sprintf) + 4;				// 190300
...
# basic.c:2527: 	K_API_SPRINTF[K_VSPRINTF]	= 	((int)vsprintf) + 4;			// 190304
...
# basic.c:2529: 	K_API_GRAPHICS[K_PIXEL]		=	((int)pixel) + 4;				// 190400
...
# basic.c:2530: 	K_API_GRAPHICS[K_LINE]		=	((int)line) + 4;				// 190404
...
# basic.c:2531: 	K_API_GRAPHICS[K_CIRCLE]	=	((int)circle) + 4;				// 190408
...
# basic.c:2532: 	K_API_GRAPHICS[K_DRAW]		=	((int)draw) + 4;				// 190412
...
main:
	...
	mov.w	r13, sp	#,
	sub.w	sp, 28 #111	#,
# basic.c:2540: 	program_start = program;
	ld.w	r0, [program]	# program.560_1, program
	st.w	[program_start], r0	# program_start, program.560_1
# basic.c:2541: 	program_end = program_start;
	ld.w	r0, [program_start]	# program_start.561_2, program_start
	st.w	[program_end], r0	# program_end, program_start.561_2
# basic.c:2542: 	bsp = program + kRamSize;  // Needed for printnum
	ld.w	r0, [program]	# program.562_3, program
	mov.w	r1, 65536	# tmp50,
	add.w	r0, r1 #222	# _4, tmp50
# basic.c:2542: 	bsp = program + kRamSize;  // Needed for printnum
	st.w	[bsp], r0	# bsp, _4
# basic.c:2543: 	stack_limit = program + kRamSize - STACK_SIZE;
	ld.w	r0, [program]	# program.563_5, program
	mov.w	r1, 65336	# tmp51,
	add.w	r0, r1 #222	# _6, tmp51
# basic.c:2543: 	stack_limit = program + kRamSize - STACK_SIZE;
	st.w	[stack_limit], r0	# stack_limit, _6
# basic.c:2544: 	variables_begin = stack_limit - 28 * VAR_SIZE;
	ld.w	r0, [stack_limit]	# stack_limit.564_7, stack_limit
	add.w	r0, -112 #111	# _8,
# basic.c:2544: 	variables_begin = stack_limit - 28 * VAR_SIZE;
	st.w	[variables_begin], r0	# variables_begin, _8
# basic.c:2546: 	current_line = 0;
	xor.w	r0, r0	# tmp52
	st.w	[current_line], r0	# current_line, tmp52
# basic.c:2548: 	init_K_API();
	call	init_K_API		#
# basic.c:2550: 	init_stdio();
	call	init_stdio		#
# basic.c:2552: 	video_mode(0);
	mov.w	r1, sp	# tmp53,
	xor.w	r0, r0	# tmp54
	st.w	[r1], r0	#, tmp54
	call	video_mode		#
# basic.c:2553: 	color = 1;
	mov.w	r0, 1	# tmp55,
	st.w	[color], r0	# color, tmp55
# basic.c:2554: 	cls(color);
	ld.w	r0, [color]	# color.565_9, color
	mov.w	r1, sp	# tmp56,
	st.w	[r1], r0	#, color.565_9
	call	cls		#
# basic.c:2555: 	uart_init_files();
	call	uart_init_files		#
# basic.c:2556: 	init_spi();
	call	init_spi		#
# basic.c:2557: 	if(!sdcard_init())
	call	sdcard_init		#
# basic.c:2557: 	if(!sdcard_init())
	zex.b	r1, r0	# tmp57, _10
	xor.w	r0, r0	# tmp58
	cmp.w	r1, r0	# tmp57, tmp58
	jnz	.L502		#
# basic.c:2559: 		printf("SD card init failed!\n");
	mov.w	r1, sp	# tmp59,
	mov.w	r0, .LC74	# tmp60,
	st.w	[r1], r0	#, tmp60
	call	puts		#
.L502:
# basic.c:2561: 	if (!volume_init(1))
	mov.w	r1, sp	# tmp61,
	mov.w	r0, 1	# tmp62,
	st.w	[r1], r0	#, tmp62
	call	volume_init		#
# basic.c:2561: 	if (!volume_init(1))
	zex.b	r1, r0	# tmp63, _11
	xor.w	r0, r0	# tmp64
	cmp.w	r1, r0	# tmp63, tmp64
	jnz	.L503		#
# basic.c:2563: 		printf("SD card volume failed!\n");
	mov.w	r1, sp	# tmp65,
	mov.w	r0, .LC75	# tmp66,
	st.w	[r1], r0	#, tmp66
	call	puts		#
.L503:
# basic.c:2566: 	init_eth();
	call	init_eth		#
# basic.c:2568: 	exec_mem();
	call	exec_mem		#
# basic.c:2570: 	init_timer();
	call	init_timer		#
# basic.c:2572: 	res = 0;
	xor.w	r0, r0	# tmp67
	st.w	[r13 + (-4)], r0	# res, tmp67
.L514:
# basic.c:2575: 		if (res != 3)
	ld.w	r1, [r13 + (-4)]	# tmp68, res
	mov.w	r0, 3	# tmp69,
	cmp.w	r1, r0	# tmp68, tmp69
	jz	.L504		#
# basic.c:2577: 			getln('>');
	...
	st.w	[r1], r0	#, tmp71
	call	getln		#
# basic.c:2578: 			toUppercaseBuffer();
	call	toUppercaseBuffer		#
# basic.c:2579: 			skip_to_end();
	call	skip_to_end		#
	j	.L505		#
.L504:
# basic.c:2583: 			res = 0;
	xor.w	r0, r0	# tmp72
	st.w	[r13 + (-4)], r0	# res, tmp72
# basic.c:2584: 			toUppercaseBuffer();
	call	toUppercaseBuffer		#
.L505:
# basic.c:2587: 		linenum = testnum();
	call	testnum		#
# basic.c:2587: 		linenum = testnum();
	st.w	[linenum], r0	# linenum, _12
# basic.c:2589: 		ignore_blanks();
	call	ignore_blanks		#
# basic.c:2591: 		if (linenum == 0)
	ld.w	r1, [linenum]	# linenum.566_13, linenum
# basic.c:2591: 		if (linenum == 0)
	xor.w	r0, r0	# tmp73
	cmp.w	r1, r0	# linenum.566_13, tmp73
	jnz	.L506		#
.L512:
# basic.c:2594: 				res = direct();
	call	direct		#
	st.w	[r13 + (-4)], r0	# res,
# basic.c:2595: 				if (res == 1)
	ld.w	r1, [r13 + (-4)]	# tmp74, res
	mov.w	r0, 1	# tmp75,
	cmp.w	r1, r0	# tmp74, tmp75
	jnz	.L507		#
# basic.c:2596: 					return 0;
	xor.w	r0, r0	# _71
	j	.L515		#
.L507:
# basic.c:2597: 				if (res == 2)
	ld.w	r1, [r13 + (-4)]	# tmp76, res
	mov.w	r0, 2	# tmp77,
	cmp.w	r1, r0	# tmp76, tmp77
	jnz	.L509		#
# basic.c:2599: 					txtpos = current_line + sizeof(LINENUM) + sizeof(char);
	ld.w	r0, [current_line]	# current_line.567_14, current_line
	add.w	r0, 5 #111	# _15,
# basic.c:2599: 					txtpos = current_line + sizeof(LINENUM) + sizeof(char);
	st.w	[txtpos], r0	# txtpos, _15
# basic.c:2600: 					continue;
	j	.L510		#
.L509:
# basic.c:2602: 				ignore_blanks();
	call	ignore_blanks		#
# basic.c:2603: 				if (*txtpos == NL || *txtpos != ':')
	ld.w	r0, [txtpos]	# txtpos.568_16, txtpos
	ld.b	r0, [r0]	# _17, *txtpos.568_16
# basic.c:2603: 				if (*txtpos == NL || *txtpos != ':')
	...
	jz	.L514		#
# basic.c:2603: 				if (*txtpos == NL || *txtpos != ':')
	ld.w	r0, [txtpos]	# txtpos.569_18, txtpos
	ld.b	r0, [r0]	# _19, *txtpos.569_18
# basic.c:2603: 				if (*txtpos == NL || *txtpos != ':')
	...
	jnz	.L514		#
# basic.c:2605: 				txtpos++;
	ld.w	r0, [txtpos]	# txtpos.570_20, txtpos
	add.w	r0, 1 #111	# _21,
	st.w	[txtpos], r0	# txtpos, _21
# basic.c:2606: 				ignore_blanks();
	call	ignore_blanks		#
.L510:
# basic.c:2594: 				res = direct();
	j	.L512		#
.L506:
# basic.c:2609: 		else if (linenum == 0xFFFF)
	ld.w	r1, [linenum]	# linenum.571_22, linenum
# basic.c:2609: 		else if (linenum == 0xFFFF)
	mov.w	r0, 65535	# tmp82,
	cmp.w	r1, r0	# linenum.571_22, tmp82
	jnz	.L513		#
# basic.c:2611: 			qhow();
	call	qhow		#
	j	.L514		#
.L513:
# basic.c:2615: 			entered_with_line_num();
	call	entered_with_line_num		#
# basic.c:2575: 		if (res != 3)
	j	.L514		#
.L515:
